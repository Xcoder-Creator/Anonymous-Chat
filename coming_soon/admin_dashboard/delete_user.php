<?php 
    ...
    if (!isset($_SESSION["delete_user_id"])){
        ...
        $id = str_replace('"', "", trim(stripcslashes(stripslashes(htmlspecialchars(htmlentities(filter_var($_SESSION["delete_user_id"], FILTER_SANITIZE_STRING)))))));
...
<head lang="en-Us">
    ...
    <!-- All meta information for the delete user page -->
    <meta charset="UTF-8">
    ...
    <!-- Css files to be used on the delete user page -->
...
<body>
    ...
    <main id="main-body_content">
        <section>
            <div class="container">
                <div>
                    <h2 style="font-size: 1.9rem; font-weight: 600;">Delete User</h2>
                    <p>You are now about to delete this particular user.<br><b>Do you still want to go ahead with this process ?</b></p>
                    <p>
                        <form method="POST" action="<?php echo htmlentities(htmlspecialchars($_SERVER['PHP_SELF'])); ?>">
                            <button type="submit" class="btn" name="del_user"><I class="fa fa-check"></i> YES</button>
                        </form>
    ...
    <!-- Javascript files used for the delete user page -->
