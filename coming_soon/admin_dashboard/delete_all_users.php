...
<head lang="en-Us">
    ...
    <!-- All meta information for the delete all users page -->
    <meta charset="UTF-8">
    ...
    <!-- Css files to be used on the delete all users page -->
...
<body>
    ...
    <main id="main-body_content">
        <section>
            <div class="container">
                <div>
                    <h2 style="font-size: 1.9rem; font-weight: 600;">Delete All Users</h2>
                    <p>You are now about to delete all users.<br><b>Do you still want to go ahead with this process ?</b></p>
                    <p>
                        <form method="POST" action="<?php echo htmlentities(htmlspecialchars($_SERVER['PHP_SELF'])); ?>">
                            <button type="submit" class="btn" name="del_all_users"><I class="fa fa-check"></i> YES</button>
                        </form>
    ...
    <?php 
        if (isset($_POST['del_all_users'])){
            ...
            if ($query->execute()){
                $query = $conn->prepare("
                    ALTER TABLE user_details AUTO_INCREMENT = 0;
                ");
                ...
                if ($query->execute()){
                    echo "
                        <script>
                            ...
                            window.alert(\"All users deleted successfully!\");
    ...
    <!-- Javascript files used for the delete all users page -->
