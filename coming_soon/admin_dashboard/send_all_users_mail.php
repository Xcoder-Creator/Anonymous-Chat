...
<head lang="en-Us">
    ...
    <!-- All meta information for the send all users mail page -->
    <meta charset="UTF-8">
    ...
    <!-- Css files to be used on the send all users mail page -->
...
<body>
    ...
    <main id="main-body_content">
        <section>
            <div class="container">
                <div>
                    <h2 style="font-size: 1.9rem; font-weight: 600;">Send Mail To All Users</h2>
                    <p>Using the text area below, You can compose mails and send them to all users.</p>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div id="err_txt"></div>
    ...
    <?php 
        if (isset($_POST['send_mail'])){
            if (isset($_POST['mail_text']) && strlen($_POST['mail_text']) >= 60){
                ...
                foreach ($rows as $send_mail){
                    $name_of_user = $send_mail[1];
                    $email_of_user = $send_mail[3];
                    ...
                    try {
                        ...
                        $mail->addAddress("$email_of_user", "$name_of_user"); //The users name and email address
    ...
    <!-- Javascript files used for the send all users mail page -->
