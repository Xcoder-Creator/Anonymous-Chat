<?php 
    ...
    if (!isset($_SESSION["data_id"])){
        ...
        $id = str_replace('"', "", trim(stripcslashes(stripslashes(htmlspecialchars(htmlentities(filter_var($_SESSION["data_id"], FILTER_SANITIZE_STRING)))))));
...
<head lang="en-Us">
    ...
    <!-- All meta information for the delete subscriber page -->
    <meta charset="UTF-8">
    ...
    <!-- Css files to be used on the delete subscriber page -->
...
<body>
    ...
    <main id="main-body_content">
        <section>
            <div class="container">
                <div>
                    <h2 style="font-size: 1.9rem; font-weight: 600;">Delete Subscriber</h2>
                    <p>You are now about to delete this particular subscriber.<br><b>Do you still want to go ahead with this process ?</b></p>
                    <p>
                        <form method="POST" action="<?php echo htmlentities(htmlspecialchars($_SERVER['PHP_SELF'])); ?>">
                            <button type="submit" class="btn" name="del_subs"><I class="fa fa-check"></i> YES</button>
                        </form>
                ...
                if (count($rows) == 0){
                    ...
                    if ($query->execute()){
                        echo "
                            <script>
                              document.write(\" \");
                              window.alert(\"Subscriber deleted successfully!\");
                              window.location.href = \"admin_profile.php\";
                            </script>
                        ";
                    }
    ...
    <!-- Javascript files used for the delete subscriber page -->
