<?php 
  session_start(); //Starting up sessions for the web application through the netw_err page
  
  if (isset($_SESSION['err_net_token'])){
	unset($_SESSION['err_net_token']);
  } else {
	header("Location: ../login.php"); //Redirect the user to the login page, if the err_net_token is not set  
  }
?>
<!DOCTYPE html>
<html lang="en-Us">
<head>
	<!-- All meta information for the netw_err page -->
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, shrink-to-fit=no">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<meta name="author" content="Michael Alfred">
	<meta name="description" content="An error has occured, Network connection issues!">
	<meta name="keywords" content="chat, anonymous-chat, message, messaging, anonymous, chatting">
	<!-- Webpage title -->
    <title>Anonymous-chat | Network Error Message</title>
	<!-- Css files to be used for the general styling of the netw_err page -->
	<link rel="stylesheet" href="../fonts/material-icon/css/material-design-iconic-font.min.css">
	<link rel="stylesheet" href="../css/anonymous-chat_styles.css">
	<link rel="stylesheet" href="../css/font-awesome.min.css">
	<!-- The image icon to be used on the browser tab for the netw_err page -->
...
<body>
	...
	<!-- The div container containing the netw_err content -->
    <div class="main">
        <section class="signup">
            <div class="container">
                <div class="signup-content" style="background-color: #d4eeef;">
                    <div class="signup-form">
                        <h2 style="margin-bottom: 16px; text-transform: none; color: red; font-size: 23px;" class="form-title">Oops, Network Issues!</h2>
						...
						<p style="text-align: left; margin-top: 4px; font-size: 12px;">Your network might be slow or your connection to the internet might not be valid. Please try again by clicking the button above.</p>
	...
	<!-- Javascript files to be used on the netw_err page -->
